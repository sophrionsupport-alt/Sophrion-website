...
export default function JoinForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setResult({
        ok: true,
        message:
          "Thanks — we received your application. Our team will follow up soon.",
      });
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-4 rounded-2xl border border-white/10 bg-white/3 p-6 backdrop-blur"
    >
      ...
      <label className="block text-sm">
        ...
        <select
          ...
          onChange={(e) =>
            setField(
              "year",
              e.target.value as FormState["year"]
            )
          }
        >
      ...
      <label className="block text-sm">
        ...
        <select
          ...
          onChange={(e) =>
            setField(
              "pathway",
              e.target.value as FormState["pathway"]
            )
          }
        >
          <option value="ai_systems">AI Systems</option>
          <option value="data_intelligence">
            Data Intelligence
          </option>
          <option value="creative_ai">
            Creative AI
          </option>
          <option value="cloud_cyber">
            Cloud & Cyber
          </option>
          <option value="smart_engineering">
            Smart Engineering
          </option>
      ...
      <label className="block text-sm">
        ...
        <textarea
          ...
          placeholder="Tell us about your interests, goals, or why you want to join Sophrion."
          value={form.message}
          onChange={(e) =>
      ...
      <button
        type="submit"
        disabled={loading}
        className="flex w-full items-center justify-center rounded-xl bg-linear-to-r from-[hsl(var(--brand-600))] to-[hsl(var(--cyan-500))] px-4 py-2.5 text-center text-sm font-semibold text-white shadow-lg transition hover:opacity-95 disabled:opacity-60"
      >
